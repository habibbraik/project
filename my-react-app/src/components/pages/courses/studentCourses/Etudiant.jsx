...
const Etudiant = () => {
    ...
    // const {t} = useTranslation();
        ...
        const étudiant = data.filter(item => item.level === 'étudiant');
    
        // Extract unique categories from the original data
        const uniqueCategories = Array.from(new Set(étudiant.map(item => item.category)));
        ...
        const filteredData = dataa.filter(item => item.level === 'étudiant');
