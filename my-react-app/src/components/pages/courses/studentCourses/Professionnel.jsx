...
const Professionnel = () => {
    ...
    // const {t} = useTranslation();
        ...
        const professionnel = data.filter(item => item.level === 'professionnel');
    
        // Extract unique categories from the original data
        const uniqueCategories = Array.from(new Set(professionnel.map(item => item.category)));
        ...
        const filteredData = dataa.filter(item => item.level === 'professionnel');
  return (
    <>
    <SecondNavbar/>
